"""Native reusable HTTPX transport with conservative synchronous retries."""
...
from parampilot.transport.sync_buffered import send_buffered_response
from parampilot.transport.sync_streaming import open_stream_response


class SyncTransport:
    """Issue authenticated requests through one native synchronous HTTPX pool.

    Args:
        configuration: Validated SDK connection and retry settings.
        http_client: Optional caller-owned HTTPX sync client.
    ...
    def __init__(
        ...
        """Initialize an owned or injected synchronous HTTP client.
        ...
        if http_client is not None and not isinstance(http_client, httpx.Client):
            raise ConfigurationError("http_client must be an httpx.Client")
    ...
    def _headers(
        ...
        *,
        ...
        Raises:
            ConfigurationError: If callers override protected headers.
    ...
    def request_operation(
        ...
        *,
        ...
        """Issue one generated operation with its shared retry classification.
    ...
    def request_raw(
        ...
        *,
        ...
        """Issue an explicitly untyped non-retrying public-v2 request.
    ...
    def stream_operation(
        ...
        *,
        ...
        """Open an unbuffered successful sync operation response.
    ...
    def request_json(self, method: str, path: str) -> dict[str, Any]:
        """Retain the foundation's raw JSON-object compatibility helper.
        ...
        """
        response = self.request_raw(method, path, accept="application/json")
        value = response.json()
