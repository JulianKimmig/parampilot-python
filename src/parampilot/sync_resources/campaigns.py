"""Synchronous campaign collection, detail, and lifecycle operations."""
...
from parampilot.sync_resources.campaign_configuration import (
    SyncCampaignConfigurationMethods,
)


class SyncCampaignsResource(SyncCampaignConfigurationMethods):
    """Typed synchronous access to campaign resources and configuration."""
    ...
    def iterate(self, *, limit: int = 100) -> Iterator[CampaignSummaryResponse]:
        ...
        Returns:
            Lazy synchronous campaign iterator.

        """

        def fetch(cursor: str | None) -> CampaignPageResponse:
        ...
        return iterate_cursor_sync(fetch, operation_id="listCampaigns")

    def get(self, campaign_id: UUID | str) -> CampaignResponse:
        ...
        """
        return self.get_with_metadata(campaign_id).data
    ...
    def get_status(self, campaign_id: UUID | str) -> CampaignStatusResponse:
