"""Asynchronous experiment collection, import, detail, and mutation operations."""
...
from parampilot.resources.experiment_imports import ExperimentImportMethods
...
class ExperimentsResource(ExperimentImportMethods):
    """Typed asynchronous experiment resource including streamed exports."""
    ...
    def iterate(
        ...
        *,
        ...
        Returns:
            Lazy asynchronous experiment iterator.

        """

        async def fetch(cursor: str | None) -> ExperimentPageResponse:
        ...
        return iterate_cursor(fetch, operation_id="listExperiments")
    ...
    async def get(
        ...
        """
        return (await self.get_with_metadata(campaign_id, experiment_id)).data
