"""Asynchronous campaign domain, strategy, metadata, and effect replacements."""
...
class CampaignConfigurationMethods(AsyncResource):
    """Typed complete-replacement operations mixed into campaign resources."""
    ...
    async def replace_additional_fields(
        self,
        campaign_id: UUID | str,
